...
public class ClipboardUtils {
     ...
     */
    private final String LABEL_TEXT="text";
    private final String LABEL_HTML="html";
    private final String LABEL_URI="uri";
    private final String LABEL_INTENT="intent";
    private final String LABEL_MULTY="multy";
    ...
    public void copyText(String text) {
        ClipData clip = ClipData.newPlainText(LABEL_TEXT, text);
        mClipboardManager.setPrimaryClip(clip);
        ToastUtils.showSafeToast(mContext.getResources().getString(R.string.copy_success));
    }
     ...
     * @param htmlText
     */
    public void copyHtmlText( String text, String htmlText) {
        ClipData clip = ClipData.newHtmlText(LABEL_HTML, text, htmlText);
        mClipboardManager.setPrimaryClip(clip);
    }
    ...
    public void copyIntent( Intent intent) {
        ClipData clip = ClipData.newIntent(LABEL_INTENT, intent);
        mClipboardManager.setPrimaryClip(clip);
    }
    ...
    public void copyUri( Uri uri) {
        ClipData clip = ClipData.newUri(mContext.getContentResolver(), LABEL_URI, uri);
        mClipboardManager.setPrimaryClip(clip);
    }
    ...
    public void copyMultiple(String label, String mimeType, List<ClipData.Item> items) {
        ...
        int size = items.size();
        ClipData clip = new ClipData(LABEL_MULTY, new String[]{mimeType}, items.get(0));
